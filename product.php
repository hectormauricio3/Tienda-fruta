...
<body >
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav flex-grow-1 justify-content-between">
                ...
                <li class="nav-item"><a class="nav-link" href="#"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">producto</font></font></a></li>
    ...
    <div class="container">
      <h1 class="card-title">Nuestro producto</h1>
      ...
      <div class="row row-cols-1 row-cols-md-2 mb-2">
        <div class="col">
          <div class="card mb-4 rounded-2 shadow-sm">
            <div class="card-body">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRi5L9VJLtgDlF_v-AbPSoKcE2or2Vv27fzkQ&s" width="100%" height="100%" alt="">
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card mb-4 rounded-2 shadow-sm">
            <div class="card-body">
              <h1 class="card-title" style="font-size:40px;">Fresas</h1>
              <h1 class="card-title pricing-card-title" style="font-size:25px;">$50 por paquete</h1>
              <p style="text-align: justify;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam ullamcorper purus non nulla tincidunt, id lobortis lorem malesuada.</p>
              <button class="w-100 btn btn-primary btn-lg" type="submit">Añadir al carro</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row row-cols-1 row-cols-md-3 mb-3">
        ...
        <div class="col">
          <div class="card mb-2 rounded-3 shadow-sm" style="max-width: 250px; margin: auto; font-size: 0.9rem;">
